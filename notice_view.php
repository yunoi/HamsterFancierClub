...
<?php
  if($userId === $id){
    echo("
      ...
      <li><button id='btn_modify' onclick=\"location.href='notice_form.php?page=$page&num=$num&mode=update'\">수정</button></li>
      <li><button id='btn_delete' onclick=\"location.href='notice_crud.php?page=$page&num=$num&mode=delete'\">삭제</button></li>
